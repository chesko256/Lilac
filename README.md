...
Lilac requires SKSE 1.7.3+ to compile and execute tests. This does not mean that your mod's requirements will change; Lilac tests are for you, the mod developer. If your mod didn't require SKSE before, Lilac won't change that.
